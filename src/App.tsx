                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                  <div className="flex bg-white/5 p-1 rounded-xl border border-white/10">
                    <button 
                      ...
                      className={`px-4 py-1.5 rounded-lg text-xs font-bold uppercase tracking-widest transition-all ${!showArchived ? 'bg-white/10 text-white' : 'text-white/40 hover:text-white'}`}
                    >
                      Active
                    </button>
                    <button 
                  ...
                  {!showArchived && (
                    <button 
                      ...
                      className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#EAB308] hover:text-white transition-colors bg-white/5 px-4 py-2 rounded-xl border border-[#EAB308]/20"
                    >
